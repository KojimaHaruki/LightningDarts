...
private:
    const std::string mName[Kind::NUM] = { "Total", "BGM", "SE" };
    int mIsBGMPlayed = TRUE;
    int mBGMVol = 0;
    int mSEVol = 0;
    int mVol[Kind::NUM] = {}; // SoundVol[SoundNo] SoundNo 0: Total, 1: BGM, 2: SE
    int mBGMPlayMode = PlayMode::RANDAM; // BGM 0: Loop, 1: Ascending order, 2: Decending order, 3: Random
